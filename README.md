...
- [Storywise](https://joinstorywise.com/) - Easy to use analytics tool, multi-database, extremely simple to self-host, privacy friendly. ([Source Code](https://github.com/dotmethodme/storywise/)) `GPL-3.0` `Nodejs/K8S`
